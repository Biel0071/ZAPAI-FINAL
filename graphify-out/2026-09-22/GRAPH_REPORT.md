...
## Corpus Check
- 1031 files · ~7,753,393 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8466 nodes · 14048 edges · 738 communities (569 shown, 169 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 1258 edges (avg confidence: 0.53)
...
- vite.config.ts.timestamp-1784811454375-9d341ce378609.mjs
- logs.sh
...
## Communities (738 total, 169 thin omitted)

### Community 0 - "button.tsx"
Cohesion: 0.03
Nodes (78): AIAssistantAvatar(), AIAssistantAvatarProps, CampaignPreview(), CampaignPreviewProps, CampaignStepItem, StructuredCampaignPayload, renderMessageWithVariables(), WhatsAppMessagePreview() (+70 more)
...
Cohesion: 0.02
Nodes (108): AnalyticsChartPoint, AnalyticsDistributionPoint, AnalyticsKpiCard, AnalyticsLovableViewModel, createAnalyticsLovableViewModel(), resolveMetric(), toNumber(), buildAggregates() (+100 more)
...
Cohesion: 0.04
Nodes (61): QRCode, toQrDataUrl(), sessionPhoneFromSock(), { activeSessions }, agentMemoryGraphService, aiDebounceMessages, aiDebounceTimers, { buildInboundDebugPayload } (+53 more)

### Community 7 - "utils.ts"
Cohesion: 0.04
Nodes (82): react, AILovableSection, AILovableViewModel, createAILovableViewModel(), AILearningDashboard(), issueLabel, BlacklistPanel(), VoiceConfigDrawer() (+74 more)

### Community 8 - "campaignDispatchEngine.js"
Cohesion: 0.05
Nodes (74): aiIntelligenceService, aiLearningEngine, aiLogService, { analyzeDoc }, { analyzeErrorLogs }, { analyzeProject }, { analyzeRuntime }, { analyzeUIScreens } (+66 more)
...
Cohesion: 0.15
Nodes (14): analyzeIncomingMessage(), conversationRepository, conversationRuntimeService, filterOwnSessionConversation(), getCompanyId(), getConversationPhone(), getSessionOwnPhones(), listConversations() (+6 more)

### Community 11 - "stableSession.js"
Cohesion: 0.03
Nodes (82): cleanMocks(), path, { query }, check(), { query }, inspectLogDetail(), { query }, inspectLogs() (+74 more)
...
Cohesion: 0.06
Nodes (61): ContactListItem, ContactsLovableViewModel, ContactsSummaryCard, ContactGrid(), ContactGridItem, ContactGridProps, formatUpdatedAt(), getInitials() (+53 more)

### Community 14 - "utils.tsx"
Cohesion: 0.08
Nodes (50): fallback(), MasterAdmins(), MasterLogs(), MasterVersions(), buildGlobalOverview(), buildMetrics(), EndpointProbeResult, extractDataObject() (+42 more)

### Community 15 - "AIView.tsx"
Cohesion: 0.10
Nodes (34): CatchAllRoute(), LoginRoute(), RequireAdminAuth(), RootRoute(), ConnectionLostOverlay(), buildSession(), decodeJwtExpiry(), LoginInput (+26 more)
...
### Community 17 - "query"
Cohesion: 0.13
Nodes (31): createInboxLovableViewModel(), AILearningSidebar(), getInboxUnreadTotal(), publishInboxUnreadTotal(), ChatListPanel(), BUSINESS_TAG_OPTIONS, formatRelativeTime(), getProviderIcon() (+23 more)
...
Cohesion: 0.11
Nodes (37): selectRandomActiveAgent(), getDelayMs(), toNumber(), agentsByTenant, { buildPersonalityPrompt }, cloneAgent(), cloneAgents(), createAgent() (+29 more)
...
Cohesion: 0.18
Nodes (5): { query: dbQuery }, registryState, express, { query }, router
...
Cohesion: 0.07
Nodes (40): { normalizeWhatsappJid }, db, { normalizePhone }, run(), conversationRepository, CONVERSATIONS_ROOT, fs, messageRepository (+32 more)
...
Cohesion: 0.07
Nodes (43): CampaignsLovableViewModel, createCampaignsLovableViewModel(), AICampaignModal(), CampaignContextInput(), CampaignContextInputProps, ContextAnalysisSummary, extractSemanticInsights(), UploadedFileItem (+35 more)
...
Cohesion: 0.11
Nodes (38): cron, { getAgentsSync }, { query }, { sendMessage }, startCron(), fs, getDocumentFileName(), getMediaUrlPayload() (+30 more)

### Community 41 - "Changelog — Refatoração do backend/crm"
Cohesion: 0.12
Nodes (17): createSettingsLovableViewModel(), SettingsLovableViewModel, UnderConstruction(), UnderConstructionProps, SettingsView(), SettingsViewProps, DiagnosticsPage, LANGUAGE_OPTIONS (+9 more)

### Community 42 - "ai.service.js"
Cohesion: 0.10
Nodes (50): DEFAULT_QUICK_REPLIES, EMPTY_MESSAGES_ARRAY, useInboxState(), buildFallbackConversationId(), clearDraftFromStorage(), countNewMessageEntries(), dedupeConversationsByScope(), detectMediaType() (+42 more)
...
Cohesion: 0.15
Nodes (11): CRMContext, CRMIntelligenceEngine, CRMMetrics, funnelStage, historyStage, intentStage, persistStage, realtimeStage (+3 more)
...
### Community 51 - "error"
Cohesion: 0.07
Nodes (47): addMessageToRealtimeStore(), buildMediaEventPayload(), computeReconnectDelay(), createStableSession(), ensureEnterpriseQueues(), loadRealtimeHistory(), pino, processContactForLidMapping() (+39 more)
...
Cohesion: 0.06
Nodes (43): FunnelStage, { getNextFunnelStage }, aiIntelligenceService, { buildLeadTags }, TagStage, { getLogger }, loadTask(), logger (+35 more)

### Community 55 - "ZapFlow System - Quick Start Guide"
Cohesion: 0.06
Nodes (38): AdminHub, AI, AuthenticatedAppShell, Campaigns, Connections, Contacts, Dashboard, Diagnostics (+30 more)
...
Cohesion: 0.10
Nodes (22): createFlowsLovableViewModel(), FlowItem, FlowsLovableViewModel, SheetContent, SheetContentProps, SheetDescription, SheetFooter(), SheetHeader() (+14 more)
...
Cohesion: 0.08
Nodes (32): getCompanyId(), cloneAIAgent(), createAIAgent(), deleteAIAgent(), getAIAgents(), getAIEvolution(), getPipelineLogs(), toggleAIAgent() (+24 more)
...
Cohesion: 0.05
Nodes (53): { backendLog }, campaignDispatchEngine, campaignRepository, cron, startCampaignScheduler(), { activeSessions }, { backendLog, errorLog }, checkAndRecoverSessions() (+45 more)
...
Cohesion: 0.08
Nodes (39): createCampaign(), { Pool }, { v4: uuidv4 }, executeStartupScript(), path, showConfirmationDialog(), { spawn }, startRuntimeProcesses() (+31 more)
...
Cohesion: 0.09
Nodes (25): ABSENCE_COOLDOWN_MS, absenceCooldowns, aiIntelligenceService, { analyzeLeadIntent }, { buildLeadTags, getNextFunnelStage }, checkLeadBlocked(), contactRepository, conversationRepository (+17 more)
...
Cohesion: 0.10
Nodes (19): bootstrapAgentMemoryGraph(), bootstrappedScopes, crypto, extractConcepts(), getGraphSnapshot(), hash(), normalizeKey(), { query } (+11 more)
...
Cohesion: 0.12
Nodes (19): ConnectionsLovableViewModel, createConnectionsLovableViewModel(), EmptyState(), EmptyStateProps, CardSkeleton(), ListSkeleton(), StatGridSkeleton(), ConnectionsView() (+11 more)
...
Cohesion: 0.08
Nodes (37): AIIcon(), AIIconProps, CONTEXTUAL_TIPS, FloatingMascotAssistant(), MainLayout(), MobileBottomNav(), MobileTabItem, NewConversationDialog() (+29 more)
...
Cohesion: 0.23
Nodes (9): aiResponseEngine, { getClient }, testChain(), { DEFAULT_SYSTEM_PROMPT }, formatConversationMessages(), generateConversationSummaryWithAI(), { getActivePrompt }, getClient() (+1 more)
...
Cohesion: 0.13
Nodes (17): removed, shouldStart, stopResult, cleanRuntimeArtifacts(), ensureLogsDir(), formatProcessSummary(), officialPorts, removePath() (+9 more)
...
Cohesion: 0.23
Nodes (18): { analyzeImageWithVision }, assertPayload(), createQuickReply(), crypto, DATA_FILE, ensureDataFile(), fs, listQuickReplies() (+10 more)
...
Cohesion: 0.10
Nodes (28): LeadMemoryGraphModalProps, Header(), HeaderProps, Skeleton(), Table, TableBody, TableCaption, TableCell (+20 more)
...
Cohesion: 0.29
Nodes (4): historyCache, historyCache, HistoryStage, messageRepository
...
Cohesion: 0.16
Nodes (17): InboxLovableViewModel, ActiveChatPaneProps, ConversationRowData, SidebarPanelProps, ZaiAssistantComposerProps, AiMemoryRecord, ComposerAttachment, ConversationDraftState (+9 more)
...
Cohesion: 0.13
Nodes (15): autoprefixer, eslint, devDependencies, autoprefixer, eslint, globals, @types/node, typescript (+7 more)
...
Cohesion: 0.11
Nodes (23): analysisWindow(), buildCandidate(), classifyAuthor(), crypto, HistoryLearning, isHeldOut(), normalizeAnalysis(), redact() (+15 more)
...
Cohesion: 0.15
Nodes (11): connectionString, lidMapper, { Pool }, registry, resolve(), waitMs(), wait(), assert (+3 more)
...
Cohesion: 0.12
Nodes (22): ActiveChatPane(), MessageRow, ContactDirectory, decodeFileName(), extensionFromMimeType(), extractMessageAssetUrl(), fallbackMediaFileName(), formatPlaybackTime() (+14 more)
...
Cohesion: 0.07
Nodes (31): SystemHealthMatrix(), Action, ActionType, actionTypes, addToRemoveQueue(), dispatch(), genId(), listeners (+23 more)
...
Cohesion: 0.06
Nodes (33): 1. Multiple Instance Prevention, 1. Run the Agent, 2. Activate from Frontend, 2. Automatic ngrok Health Checks, 3. Check Status, 3. Graceful Process Management, 4. Comprehensive Logging, 5. Process Sequencing (+25 more)
...
Cohesion: 0.10
Nodes (21): belongsToTenant(), buildAnalyticsSummary(), normalizeTenantId(), safePercent(), analyticsService, { getCompanyId }, getDashboard(), getMetrics() (+13 more)
...
Cohesion: 0.20
Nodes (8): customerMemoryEngine, experienceEngine, express, knowledgeEngine, learningEngine, playbookEngine, { Pool }, router
...
Cohesion: 0.22
Nodes (6): customerMemoryEngine, EvolutionaryAgentOrchestrator, experienceEngine, knowledgeEngine, learningEngine, playbookEngine

### Community 357 - "doctor.sh"
Cohesion: 0.80
Nodes (5): apiEnvelopeMiddleware(), formatApiResponse(), isEnvelope(), isPlainObject(), normalizeErrorMessage()

### Community 358 - "env.sh"
Cohesion: 0.60
...
Cohesion: 0.20
Nodes (9): assert, customerMemoryEngine, { describe, it, before, after }, experienceEngine, knowledgeEngine, learningEngine, orchestrator, playbookEngine (+1 more)
...
Cohesion: 0.29
Nodes (3): PlaybookEngine, { Pool }, simpleHash()

### Community 398 - "testAgent.js"
Cohesion: 0.40
...
Cohesion: 0.29
Nodes (6): assert, conversationRepoPath, crmIntelligence, { describe, it, beforeEach }, historyCache, messageRepoPath
...
Cohesion: 0.17
Nodes (7): messageService, whatsappService, aiIntelligenceService, MessageAuditService, messageStore, sessionManager, whatsappService
...
### Community 443 - "check-duplicates.js"
Cohesion: 0.50
...
### Community 445 - "give_agent_tip.js"
Cohesion: 0.50
...
Cohesion: 0.40
Nodes (3): assert, memoryService, test
...
### Community 485 - "Project agent instructions"
Cohesion: 0.50
Nodes (3): Developer Skill, Regras Obrigatórias do Developer, Workflow
...
### Community 487 - "docker-entrypoint.sh"
Cohesion: 0.50
Nodes (3): Atualizar quando aplicável, Documentation Skill, Regra
...
### Community 489 - "check_qr.js"
Cohesion: 0.50
Nodes (3): Diretrizes, Karpathy Skill, Perguntas obrigatórias antes de codar

### Community 490 - "check-schema.js"
Cohesion: 0.50
Nodes (3): Analisar, Performance Skill, Regra

### Community 491 - "enable_ai_for_all.js"
Cohesion: 0.50
Nodes (3): Progressive Disclosure Rules, Project Context Skill, Workflow

### Community 492 - "ensure-contacts-table.js"
Cohesion: 0.50
Nodes (3): QA Detection Workflow, Universal QA Checklist, Universal QA Skill

### Community 493 - "inspect-tables.js"
Cohesion: 0.50
Nodes (3): Checklist de revisão, Code Reviewer Skill, Saída

### Community 494 - "query-db.js"
Cohesion: 0.50
Nodes (3): [1.0.0] - 2026-08-11, Added, Changelog — skill-global

### Community 495 - "verify-final.js"
Cohesion: 0.50
Nodes (3): Analytics Skill, Criar / revisar, Regra (aprendida)

### Community 496 - "contactsService.js"
Cohesion: 0.50
Nodes (3): Como usar o mapa, Graphify Skill, No início de uma tarefa estrutural

### Community 497 - "healthService.js"
Cohesion: 0.50
Nodes (3): Onde vive, Pontos de atenção, WhatsApp Skill

### Community 499 - "rateLimiter.js"
Cohesion: 0.67
Nodes (3): 🛠️ Configuration, Constants (in localRuntimeAgent.js), Environment Variables (Optional)

### Community 501 - "aiGeneratedFixes.js"
Cohesion: 0.50
...
- **Why does `query()` connect `stableSession.js` to `aiConfigService.js`, `server.js`, `Key Components`, `aiLocalBrainService.js`, `aiLogService.js`, `query`, `run-flash.js`, `components.json`, `Implementation Summary - ZapFlow Runtime Management System`, `Runtime local e modo Docker/VPS`, `use-toast.ts`, `events.js`, `outboundQueueService.js`, `system.js`, `runtimeHardening.ts`, `reconnect.js`, `productRepository.js`, `systemController.js`, `persistence.js`, `reactivationService.js`, `messageAckPipeline.js`, `index.js`, `campaignScheduler.js`, `CURRENT STATE REPORT — ZAPAI-FINAL`, `aiIntelligenceService.js`, `contactsController.js`, `messageService.js`, `[1.1.0] - 2026-07-02`, `auto-deploy.sh`, `rollback.sh`, `getEngineClient`, `healthcheck.js`, `systemControlService.ts`, `Code Reviewer Skill`, `errorLogService.ts`, `3. CONEXÕES E FLUXOS DE DADOS`, `flowRepository.js`, `aiIntelligenceStorage.js`?**
  _High betweenness centrality (0.117) - this node is a cross-community bridge._
- **Why does `error()` connect `messageService.js` to `devPipeline.js`, `Connections.tsx`, `campaignDispatchEngine.js`, `Campaigns.tsx`, `utils.ts`, `stableSession.js`, `AIView.tsx`, `aiLocalBrainService.js`, `query`, `helpers.js`, `createStableSession`, `Runtime local e modo Docker/VPS`, `events.js`, `system.js`, `Architecture Analysis and Refactor Report`, `📊 SUMÁRIO EXECUTIVO - DIAGNÓSTICO ZAPAI`, `runtimeHardening.ts`, `Changelog — Refatoração do backend/crm`, `reconnect.js`, `Settings.tsx`, `RuntimeProvider.tsx`, `error`, `systemController.js`, `aiMemoryEngine.js`, `ZapFlow PowerShell Activation Flow - Implementation Guide`, `Autonomous Improvement Skill`, `featureEngine.js`, `messageAckPipeline.js`, `index.js`, `Agente: Release`, `CURRENT STATE REPORT — ZAPAI-FINAL`, `aiIntelligenceService.js`, `getCompanyId`, `auto-deploy.sh`, `getEngineClient`, `healthcheck.js`, `conversationControlStore.ts`, `dependencies`, `doctor.sh`, `Agente: Security`, `test-socket.mjs`?**
  _High betweenness centrality (0.073) - this node is a cross-community bridge._
- **Why does `cn()` connect `button.tsx` to `cn`, `utils.ts`, `chart.tsx`, `runMigrations`, `sidebar.tsx`, `DashboardView.tsx`, `query`, `adminMasterService.ts`, `📊 SUMÁRIO EXECUTIVO - DIAGNÓSTICO ZAPAI`, `Changelog — Refatoração do backend/crm`, `ai.service.js`, `ZapFlow System - Quick Start Guide`, `featureEngine.js`, `@radix-ui/react-label`, `contactsController.js`, `adminMaster.js`, `dependencies`, `testRunnerEngine.js`, `SyncContext`, `3. CONEXÕES E FLUXOS DE DADOS`, `appStore.ts`, `FASE 1 - Mapeamento`?**
