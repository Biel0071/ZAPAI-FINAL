# Graph Report - ZAPAI-FINAL  (2026-09-09)

## Corpus Check
- 927 files · ~6,352,875 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8034 nodes · 13215 edges · 698 communities (551 shown, 147 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 1207 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ce81927c`
...
- dependencies
- runMigrations
- aiConversationMemoryService.js
...
- storage.js
- ARCHITECTURE_DEAD_CODE_REPORT.md
...
- index.js
- ai-toggle-enforcement.test.js
- campaignScheduler.js
- conversationSummarizer.js
- flowTrackerService.js
- SyncPipeline.js
...
- backend/crm
- check-duplicates.js
- create_campaign_for_user.js
- give_agent_tip.js
- inspect-contacts.js
- seed-admin.js
- setup_quick_replies.js
...
7. `Badge()` - 49 edges
8. `createStableSession()` - 48 edges
9. `Card` - 40 edges
10. `CardContent` - 39 edges
...
## Communities (698 total, 147 thin omitted)

### Community 0 - "button.tsx"
Cohesion: 0.06
Nodes (76): AIAssistantGuideCard(), ROUTE_GUIDANCE, AIExecutiveInsightData, AIExecutiveInsightsCard(), AIExecutiveInsightsCardProps, BlacklistPanel(), BlockedContact, ACTION_META (+68 more)

### Community 1 - "cn"
Cohesion: 0.02
Nodes (90): AIAssistantAvatar(), AIAssistantAvatarProps, CampaignPreview(), CampaignPreviewProps, CampaignStepItem, StructuredCampaignPayload, renderMessageWithVariables(), WhatsAppMessagePreview() (+82 more)

### Community 2 - "server.js"
Cohesion: 0.02
Nodes (79): agentEvolutionCron, aiIntelligenceService, aiMemoryEngine, { apiEnvelopeMiddleware, normalizeErrorMessage }, app, authRateLimiter, { backendLog, errorLog }, backpressureController (+71 more)
...
Cohesion: 0.04
Nodes (56): CacheRecord, getCache(), invalidateCache(), memoryCache, setCache(), Queue(), AbsenceMessageSettings, AdvancedAISettings (+48 more)
...
Cohesion: 0.05
Nodes (49): ConnectionsLovableViewModel, createConnectionsLovableViewModel(), LeadDrawerLead, LeadDrawerProps, countries, CountryCode, MediaVaultItem, MediaVaultModalProps (+41 more)
...
Cohesion: 0.05
Nodes (56): CampaignsLovableViewModel, createCampaignsLovableViewModel(), CampaignContextInput(), CampaignContextInputProps, ContextAnalysisSummary, extractSemanticInsights(), UploadedFileItem, ConversionHeatmap() (+48 more)

### Community 10 - "masterNodeService.ts"
Cohesion: 0.08
Nodes (55): isObject(), normalizeWsDeployment(), normalizeWsMetric(), normalizeWsNode(), useMasterNodesControlPlane(), EMPTY_DETAILS, useNodeDetailsControlPlane(), fallback() (+47 more)

### Community 11 - "stableSession.js"
Cohesion: 0.04
Nodes (55): QRCode, toQrDataUrl(), sessionPhoneFromSock(), { activeSessions }, agentMemoryGraphService, aiDebounceMessages, aiDebounceTimers, { buildInboundDebugPayload } (+47 more)

### Community 12 - "sidebar.tsx"
Cohesion: 0.04
Nodes (50): AIIcon(), AIIconProps, MainLayout(), NewConversationDialog(), adminItems, bottomItems, crmItems, Sidebar() (+42 more)

### Community 13 - "DashboardView.tsx"
Cohesion: 0.06
Nodes (49): AnalyticsChartPoint, AnalyticsDistributionPoint, AnalyticsKpiCard, AnalyticsLovableViewModel, createAnalyticsLovableViewModel(), resolveMetric(), toNumber(), buildAggregates() (+41 more)

### Community 14 - "utils.tsx"
Cohesion: 0.10
Nodes (52): DEFAULT_QUICK_REPLIES, EMPTY_MESSAGES_ARRAY, useInboxState(), ConversationDraftState, QuickReplyMediaItem, buildFallbackConversationId(), clearDraftFromStorage(), ContactDirectory (+44 more)

### Community 15 - "AIView.tsx"
Cohesion: 0.05
Nodes (42): AILovableSection, AILovableViewModel, createAILovableViewModel(), AILearningDashboard(), issueLabel, formatTimeAgo(), LeadReactivationPanel(), OFFICIAL_VOICES (+34 more)
...
### Community 17 - "query"
Cohesion: 0.06
Nodes (42): cleanMocks(), path, { query }, main(), { query }, main(), { query }, estimateAudience() (+34 more)

### Community 18 - "useAdminAuth.ts"
Cohesion: 0.08
Nodes (44): CatchAllRoute(), LoginRoute(), ProtectedRoute(), RequireAdminAuth(), RootRoute(), ConnectionLostOverlay(), buildSession(), decodeJwtExpiry() (+36 more)

### Community 19 - "adminMasterService.ts"
Cohesion: 0.08
Nodes (47): MasterVersions(), buildGlobalOverview(), buildMetrics(), EndpointProbeResult, extractDataObject(), extractStatus(), GitCommitRow, impersonateUser() (+39 more)
...
### Community 22 - "ZapFlow Activation System Documentation"
Cohesion: 0.04
...
Cohesion: 0.08
Nodes (38): buildMediaEventPayload(), computeReconnectDelay(), createStableSession(), ensureEnterpriseQueues(), pino, processContactForLidMapping(), scanLidMapping(), buildInboundDebugPayload() (+30 more)
...
Cohesion: 0.10
Nodes (39): { activeSessions, chats }, addTag(), archiveChat(), {
  emitChatsLoaded,
  emitChatUpdated,
}, { emitRealtimeMetrics }, { ensureRealtimeStore }, findSessionForChat(), getChatConfig() (+31 more)
...
Cohesion: 0.07
Nodes (36): react, VoiceConfigDrawer(), VoiceConfigDrawerProps, VoiceProfile, ProductsView(), useChart(), useFormField(), Slider (+28 more)
...
Cohesion: 0.10
Nodes (36): buildMediaUrl(), buildRealtimeMessageEnvelope(), dedupeMessages(), emitNewMessage(), messageRepository, { normalizePhone }, { normalizeRealtimeMediaType }, normalizeRealtimeType() (+28 more)
...
Cohesion: 0.06
Nodes (32): agentMemoryGraphService, executeFullE2ESmokeSuite(), messageAckPipeline, { query }, runSingleNodeTest(), sessionManager, whatsappService, cacheStore (+24 more)
...
Cohesion: 0.09
Nodes (32): aiLogService, axios, compileSystemPrompt(), crypto, decrypt(), { DEFAULT_SYSTEM_PROMPT }, enforceResponseWordLimit(), geocodeAddress() (+24 more)
...
Cohesion: 0.07
Nodes (29): createSettingsLovableViewModel(), SettingsLovableViewModel, UnderConstruction(), UnderConstructionProps, SheetContent, SheetContentProps, SheetDescription, SheetFooter() (+21 more)
...
Cohesion: 0.06
Nodes (24): { query: dbQuery }, { query: dbQuery }, registryState, consolidateLidConversations(), conversationRepository, { existsSync }, fs, path (+16 more)
...
### Community 51 - "error"
Cohesion: 0.11
Nodes (28): executeStartupScript(), path, showConfirmationDialog(), { spawn }, startRuntimeProcesses(), clearLogs(), ensureLogsDirectory(), error() (+20 more)
...
Cohesion: 0.06
Nodes (32): 1. services/activationConfirmationService.js, 2. controllers/systemController.js, Activation Log Entries Created, activationConfirmationService.js Functions, API Endpoint, Architecture, Configuration, Environment Variables (Optional) (+24 more)
...
Cohesion: 0.09
Nodes (25): InboxSectionBoundary, InboxSectionBoundaryProps, InboxSectionBoundaryState, ConversationRow(), FlowExecutionData, BUSINESS_TAG_OPTIONS, formatRelativeTime(), getProviderIcon() (+17 more)
...
Cohesion: 0.11
Nodes (26): aiAgentService, aiConfigService, aiMemoryEngine, crypto, decrypt(), deleteAIAgent(), encrypt(), flushMemory() (+18 more)
...
Cohesion: 0.10
Nodes (27): getCompanyId(), cloneAIAgent(), createAIAgent(), getAIEvolution(), getPipelineLogs(), toggleAIAgent(), updateAIAgent(), disable() (+19 more)
...
Cohesion: 0.12
Nodes (24): NewMessagesBanner(), NewMessagesBannerProps, useAiCountdown(), Session, ActiveChatPane(), ActiveChatPaneProps, ChatListPanelProps, ConversationRowData (+16 more)
...
### Community 79 - "IMPROVEMENTS"
Cohesion: 0.08
Nodes (25): 2026-03-20T10:53:53.410Z - Self-Improving Cycle, 2026-03-20T10:54:55.718Z - Self-Improving Cycle, 2026-03-20T10:55:05.112Z - Self-Improving Cycle, 2026-03-20T10:55:12.031Z - Self-Improving Cycle, 2026-03-20T10:55:59.968Z - Self-Improving Cycle, 2026-03-20T10:56:34.016Z - Self-Improving Cycle, 2026-03-20T10:56:59.198Z - Self-Improving Cycle, 2026-03-20T11:02:42.596Z - Self-Improving Cycle (+17 more)

### Community 80 - "ZapFlow Documentation Index"
Cohesion: 0.08
Nodes (26): 1. **QUICK_START.md** ⭐, 2. **RUNTIME_MANAGEMENT.md** 📖, 3. **FRONTEND_RECONNECTION.md** 💻, 4. **API_REFERENCE.md** 📡, 5. **ACTIVATION_SYSTEM.md** 🔐, 6. **IMPLEMENTATION_SUMMARY.md** ✅, Common Mistakes to Avoid, 📚 Complete Documentation Guide (+18 more)
...
Cohesion: 0.08
Nodes (25): cmdk, @emoji-mart/data, dependencies, cmdk, @emoji-mart/data, @radix-ui/react-dropdown-menu, @radix-ui/react-hover-card, @radix-ui/react-navigation-menu (+17 more)
...
### Community 96 - "Inbox.tsx"
Cohesion: 0.15
Nodes (18): createInboxLovableViewModel(), InboxLovableViewModel, getInboxUnreadTotal(), publishInboxUnreadTotal(), InboxView(), InboxViewProps, Dashboard(), ChatListPanel() (+10 more)

### Community 97 - "errorLogService.ts"
Cohesion: 0.11
Nodes (10): InboxRuntimeBoundary, Props, State, PageRouteBoundary, Props, State, ErrorLogPayload, _isDuplicate() (+2 more)

### Community 98 - "moduleGenerator.js"
Cohesion: 0.16
...
### Community 99 - "saasArchitectEngine.js"
Cohesion: 0.13
...
### Community 100 - "Auditoria de Production Readiness — ZAPFLOW AI / ZAPAI"
Cohesion: 0.09
...
### Community 104 - "ZapFlow Quick Reference Card"
Cohesion: 0.10
...
### Community 105 - "workerSupervisor.js"
Cohesion: 0.15
...
Cohesion: 0.12
Nodes (15): generateReply(), conversationService, conversationRepository, conversationRuntimeService, filterOwnSessionConversation(), getCompanyId(), getConversationPhone(), getSessionOwnPhones() (+7 more)
...
Cohesion: 0.14
Nodes (18): MessageRow, decodeFileName(), extensionFromMimeType(), extractMessageAssetUrl(), fallbackMediaFileName(), getExplicitMediaFileName(), getFileExtension(), getMediaFileName() (+10 more)

### Community 111 - "run-full-audit.js"
Cohesion: 0.18
...
Cohesion: 0.15
Nodes (14): LeadMemoryGraphModalProps, TabsContent, TabsList, TabsTrigger, CampaignsTab, CampaignsView(), CampaignsViewProps, MasterAdminsPage (+6 more)
...
Cohesion: 0.15
Nodes (17): buildLogger(), { createLogger, format, transports }, fs, getLogger(), LEGACY_CATEGORIES, loggers, maskSecretString(), OPERATIONAL_CATEGORIES (+9 more)

### Community 121 - "messageRepository.js"
Cohesion: 0.17
...
### Community 122 - "ai.js"
Cohesion: 0.20
Nodes (16): reply(), { DEFAULT_SYSTEM_PROMPT }, formatContextSection(), formatConversationMessages(), generateAutoReply(), generateConversationSummaryWithAI(), { getActivePrompt }, getClient() (+8 more)
...
### Community 126 - "ROUND 2 PROGRESS REPORT"
Cohesion: 0.11
...
Cohesion: 0.14
Nodes (16): agentEvolutionService, cron, { query }, startEvolutionScan(), agentLearningRepo, aiAgentService, applyAgentChanges(), crypto (+8 more)
...
### Community 137 - "Mapa de Intenção → Pipeline"
Cohesion: 0.12
...
Cohesion: 0.18
Nodes (14): initDatabase(), { Pool }, { runMigrations }, main(), { pool }, { runMigrations }, ensureMigrationsTable(), fs (+6 more)
...
### Community 141 - "automationService.js"
Cohesion: 0.24
...
### Community 142 - "campaignRuntime.js"
Cohesion: 0.16
Nodes (12): evaluateCampaign(), buildCampaignSnapshot(), emitCampaignSnapshot(), { evaluateCampaign }, startCampaignRuntime(), campaignEngine, campaignRuntime, startBackgroundServices() (+4 more)
...
### Community 158 - "aiIntelligenceController.js"
Cohesion: 0.20
...
### Community 160 - "ConversationRuntimeService.js"
Cohesion: 0.35
...
Cohesion: 0.13
Nodes (15): autoprefixer, devDependencies, autoprefixer, globals, lovable-tagger, @types/node, typescript, typescript-eslint (+7 more)

### Community 166 - "Architecture Analysis and Refactor Report"
Cohesion: 0.13
...
### Community 175 - "2026-04-27 - Operação DevOps ZAPAI-FINAL"
Cohesion: 0.13
...
### Community 176 - "Mapa de Intenção → Skills"
Cohesion: 0.13
Nodes (14): Bug de Autenticação / Segurança, Bug Fix, Database / Schema, Deploy / Release, Formato de Output do Orchestrator, Frontend / UI, Gate de Release, Mapa de Intenção → Skills (+6 more)
...
### Community 180 - "protect-whatsapp-sessions.js"
Cohesion: 0.22
...
Cohesion: 0.16
Nodes (9): aiConversationMemoryService, db, DEFAULT_COMPANY_ID, FLUSH_BATCH_SIZE, FLUSH_MAX_ENTRIES, flushMemoryToPostgres(), forceFlushMemoryToPostgres(), MIN_FLUSH_INTERVAL_MS (+1 more)
...
### Community 190 - "Ajustes visuais consolidados nesta fase"
Cohesion: 0.14
...
### Community 191 - "carousel.tsx"
Cohesion: 0.14
Nodes (13): Carousel, CarouselApi, CarouselContent, CarouselContext, CarouselContextProps, CarouselItem, CarouselNext, CarouselOptions (+5 more)

### Community 192 - "requestApiEndpoint"
Cohesion: 0.20
...
### Community 197 - "ai.js"
Cohesion: 0.17
Nodes (9): generateFollowupPlan(), { query }, analyzeLeadsForReactivation(), classifyAction(), executeReactivations(), { query }, aiController, express (+1 more)
...
Cohesion: 0.28
Nodes (12): isAIReplyStillAllowed(), disableAI(), enableAI(), enabledByTenant, getAIEnabled(), hydratedTenants, initAIToggle(), normalizeTenantId() (+4 more)

### Community 202 - "projectAnalyzer.js"
Cohesion: 0.17
...
### Community 203 - "getEngineClient"
Cohesion: 0.26
Nodes (9): { getEngineClient }, processIncomingMessage(), createFallbackEngine(), getEngineClient(), loadEngineFactory(), logFallbackInfo(), logUnavailableWarning(), shouldAllowEngineFallback() (+1 more)

### Community 204 - "acebotController.js"
Cohesion: 0.17
Nodes (6): acebot, getSelfImprovingStatus(), startSmartSelfImprovingMode(), controller, express, router

### Community 205 - "nodeMaster.js"
Cohesion: 0.21
...
### Community 206 - "designSystemExporter.ts"
Cohesion: 0.24
...
### Community 207 - "FlowsView.tsx"
Cohesion: 0.29
Nodes (8): createFlowsLovableViewModel(), FlowItem, FlowsLovableViewModel, EmptyState(), EmptyStateProps, FlowsView(), FlowsViewProps, Flows()

### Community 208 - "masterWebsocketService.ts"
Cohesion: 0.18
...
### Community 210 - "Agente: Debugger"
Cohesion: 0.15
Nodes (12): Agente: Debugger, Arquivos Proibidos Durante Diagnóstico, Arquivos que Pode Alterar, Critérios de Conclusão, Critérios de Escalação, Ferramentas Permitidas, Formato de Saída, Processo (+4 more)

### Community 211 - "Agente: Release"
Cohesion: 0.15
Nodes (12): Agente: Release, Arquivos Proibidos (NUNCA), Arquivos que Pode Alterar, Critérios de Conclusão, Critérios de Escalação, Ferramentas Permitidas, Formato de Saída, Gates — TODOS devem estar VERDE antes de qualquer ação (+4 more)
...
### Community 218 - "aiLearningEngine.js"
Cohesion: 0.27
...
Cohesion: 0.27
Nodes (10): buildConversationHistory(), buildFallbackResponse(), { buildPersonalityPrompt }, ensureAgent(), generateAIResponse(), { getClient }, { processEvent }, buildPersonalityPrompt() (+2 more)
...
### Community 222 - "testRunnerEngine.js"
Cohesion: 0.20
...
### Community 227 - "Agente: Architect"
Cohesion: 0.17
Nodes (11): Agente: Architect, Arquivos Proibidos, Arquivos que Pode Alterar, Critérios de Conclusão, Critérios de Escalação, Ferramentas Permitidas, Formato de Saída, Processo (+3 more)

### Community 228 - "Agente: Developer"
Cohesion: 0.17
Nodes (11): Agente: Developer, Arquivos Proibidos, Arquivos que Pode Alterar, Critérios de Conclusão, Critérios de Escalação, Ferramentas Permitidas, Formato de Saída, Processo (+3 more)
...
### Community 235 - "campaignRepository.js"
Cohesion: 0.40
...
### Community 241 - "DIAGNÓSTICO COMPLETO DO SISTEMA ZAPAI"
Cohesion: 0.18
...
### Community 260 - "ConversationRepository.js"
Cohesion: 0.33
...
### Community 261 - "UI Stability Report"
Cohesion: 0.20
...
### Community 267 - "ZapFlow System - Deployment Checklist & Summary"
Cohesion: 0.22
...
### Community 268 - "🔍 Find Information By Topic"
Cohesion: 0.22
...
### Community 276 - "sessionStateService.js"
Cohesion: 0.42
...
### Community 284 - "Roadmap MVP — ZAPAI-FINAL"
Cohesion: 0.22
...
### Community 285 - "🛠️ Fluxo de Trabalho de Atualização"
Cohesion: 0.22
...
### Community 286 - "Documentação Técnica da Arquitetura — ZAPFLOW AI"
Cohesion: 0.22
Nodes (8): 🛠️ 1. Stack de Tecnologias, 📂 2. Estrutura de Diretórios & Camadas, 🔐 3. Roteamento, Permissões e Segurança, 📈 4. Telemetria e Ciclo de Vida E2E, Backend & Integrações, Documentação Técnica da Arquitetura — ZAPFLOW AI, Fluxo de Inicialização, Frontend
...
### Community 290 - "Project Hygiene Skill"
Cohesion: 0.22
Nodes (8): Limpeza Periódica, Nomeação, O que NUNCA colocar em outros/, O que NUNCA colocar na raiz do projeto, Project Hygiene Skill, Raiz do Projeto — Permitidos, Regra Central, Árvore de Decisão

### Community 291 - "Core Security Checklist"
Cohesion: 0.22
Nodes (8): 1. Data Isolation & Multi-Tenancy (CRITICAL), 2. Authentication & Authorization, 3. Injection Prevention (SQL / NoSQL / Command), 4. Cross-Site Scripting (XSS) & Content Safety, 5. Secret Protection, 6. Rate Limiting & Input Limits, Core Security Checklist, Universal Security Skill

### Community 292 - "Autonomous Improvement Skill"
Cohesion: 0.25
...
### Community 293 - "📊 Features Implemented"
Cohesion: 0.25
...
### Community 294 - "🛠️ Common Tasks Reference"
Cohesion: 0.25
...
### Community 300 - "productRepository.js"
Cohesion: 0.29
Nodes (4): productRepository, getProductById(), listProducts(), { query }
...
### Community 304 - "WhatsApp / Sessões"
Cohesion: 0.25
...
### Community 305 - "🏛️ Camadas Arquiteturais"
Cohesion: 0.25
...
### Community 306 - "🔄 Fluxo de Trabalho de Sincronização (Lovable Sync)"
Cohesion: 0.25
...
### Community 309 - "Plano para congelar a versão oficial (a da imagem) e eliminar alternância"
Cohesion: 0.25
...
Cohesion: 0.29
Nodes (5): { backendLog }, campaignDispatchEngine, campaignRepository, cron, startCampaignScheduler()
...
### Community 337 - "CRM Intelligence Engine"
Cohesion: 0.29
...
### Community 338 - "5. PREPARAÇÃO PARA VPS"
Cohesion: 0.29
...
### Community 341 - "Release Skill"
Cohesion: 0.29
Nodes (6): Deploy — Requer Autorização Explícita, Gates Obrigatórios (todos devem estar VERDE), Processo de Release, Release Skill, Saída, Se qualquer gate falhar

### Community 342 - "Tester Skill"
Cohesion: 0.29
Nodes (6): Checklist de Cobertura, Contexto ZapFlow, Hierarquia de Testes, Saída, TDD — Ordem Obrigatória, Tester Skill

### Community 343 - "🚀 Steps to Publish `skill-global` as a Standalone Repository"
Cohesion: 0.29
...
### Community 368 - "analyze-tests.js"
Cohesion: 0.33
...
### Community 376 - "Architect Skill"
Cohesion: 0.33
Nodes (5): Architect Skill, Perguntas obrigatórias do Architect, Quando usar, Regras, Workflow

### Community 377 - "Brainstorming Skill"
Cohesion: 0.33
Nodes (5): Brainstorming Skill, Contexto ZapFlow, Fluxo, Quando Usar, Saída

### Community 378 - "Debugger Skill"
Cohesion: 0.33
Nodes (5): Debugger Skill, Fluxo Obrigatório, Onde buscar evidências no ZAPFLOW, Regras, Saída

### Community 379 - "Automation Skill"
Cohesion: 0.40
Nodes (4): Automation Skill, Componentes, Estado real (importante), Regra

### Community 380 - "autoBootstrap.js"
Cohesion: 0.40
Nodes (3): crypto, fs, path

### Community 381 - "🚀 Deployment Options"
Cohesion: 0.40
...
Cohesion: 0.40
Nodes (5): Scenario 1: System Startup, Scenario 2: ngrok Crashes, Scenario 3: Frontend Connection Loss, Scenario 4: Manual Activation (Desktop Only), Workflow Examples

### Community 393 - "Migrations"
Cohesion: 0.40
Nodes (4): Conventions, Execution, Migrations, Rollback strategy

### Community 394 - "fast-api-flood.js"
Cohesion: 0.40
...
### Community 416 - "Automation Skill"
Cohesion: 0.40
Nodes (4): Automation Skill, Componentes, Estado real (importante), Regra

### Community 417 - "Context Efficiency & Progressive Disclosure Strategy — skill-global"
Cohesion: 0.40
...
### Community 420 - "Skill Taxonomy — skill-global"
Cohesion: 0.40
...
### Community 456 - "whatsapp.js"
Cohesion: 0.50
Nodes (3): express, router, sessionsController

### Community 458 - "messageAckPipeline.test.js"
Cohesion: 0.50
Nodes (3): assert, pipeline, test

### Community 461 - "Autenticação"
Cohesion: 0.50
...
### Community 467 - "📞 SUPORTE E TROUBLESHOOTING"
Cohesion: 0.50
...
### Community 468 - "hardening-stress.spec.ts"
Cohesion: 0.50
Nodes (3): __dirname, __filename, rootDir

### Community 469 - "deploy-master.js"
Cohesion: 0.50
...
### Community 478 - "Project Context Skill"
Cohesion: 0.50
Nodes (3): Progressive Disclosure Rules, Project Context Skill, Workflow
...
### Community 480 - "Code Reviewer Skill"
Cohesion: 0.50
Nodes (3): Checklist de revisão, Code Reviewer Skill, Saída
...
### Community 482 - "Analytics Skill"
Cohesion: 0.50
Nodes (3): Analytics Skill, Criar / revisar, Regra (aprendida)

### Community 483 - "Graphify Skill"
Cohesion: 0.50
Nodes (3): Como usar o mapa, Graphify Skill, No início de uma tarefa estrutural

### Community 484 - "WhatsApp Skill"
Cohesion: 0.50
Nodes (3): Onde vive, Pontos de atenção, WhatsApp Skill

### Community 486 - "🛠️ Configuration"
Cohesion: 0.67
Nodes (3): 🛠️ Configuration, Constants (in localRuntimeAgent.js), Environment Variables (Optional)

### Community 488 - "Configuration"
Cohesion: 0.67
Nodes (3): Configuration, Constants (src/localRuntimeAgent.js), Environment Variables (Optional)

## Knowledge Gaps
- **3762 isolated node(s):** `fs`, `path`, `crypto`, `fs`, `path` (+3757 more)
...
- **Why does `query()` connect `query` to `agentEvolutionService.js`, `Contacts.tsx`, `DashboardView.tsx`, `bootstrap`, `normalizePhone`, `aiLocalBrainService.js`, `aiLogService.js`, `whatsappService.js`, `agentMemoryGraphService.js`, `audioGenerationService.js`, `outboundQueueService.js`, `system.js`, `ai.service.js`, `campaignAnalysisService.js`, `conversationRepository.js`, `productRepository.js`, `messagesController.js`, `database.js`, `error`, `reactivationService.js`, `retentionService.js`, `systemHealthAnalyzer.js`, `SidebarPanel.tsx`, `aiExecutiveInsightService.js`, `aiConfigController.js`, `ai.js`, `contactsController.js`, `operationsController.js`, `getCompanyId`, `adminMaster.js`, `sessionRepository.js`, `ActiveChatPane.tsx`, `nodeMaster.js`, `auth.js`, `aiFollowupCron.js`, `campaignRepository.js`, `flowRepository.js`?**
  _High betweenness centrality (0.113) - this node is a cross-community bridge._
- **Why does `error()` connect `error` to `runtimeManager.js`, `aiController.js`, `Connections.tsx`, `campaignDispatchEngine.js`, `Campaigns.tsx`, `bootstrap`, `activationLoggerService.js`, `aiLocalBrainService.js`, `query`, `useAdminAuth.ts`, `AIView.tsx`, `createStableSession`, `operations.js`, `stabilizationSmokeTest.js`, `runtime-lib.mjs`, `outboundQueueService.js`, `system.js`, `conversation.js`, `queue-service.js`, `ai.service.js`, `senders.js`, `Settings.tsx`, `messagesController.js`, `systemController.js`, `selfHealer.js`, `bugWatcher.js`, `EventBus`, `persistence.js`, `quickReplyService.js`, `systemHealthAnalyzer.js`, `create_campaign_for_user.js`, `aiConfigController.js`, `requestApiEndpoint`, `contactsController.js`, `operationsController.js`, `getCompanyId`, `adminMaster.js`, `nodeMaster.js`, `aiFollowupCron.js`, `Inbox.tsx`, `apiEnvelope.js`, `systemManager.js`?**
  _High betweenness centrality (0.086) - this node is a cross-community bridge._
- **Why does `cn()` connect `cn` to `button.tsx`, `Connections.tsx`, `utils.ts`, `chart.tsx`, `Campaigns.tsx`, `Contacts.tsx`, `sidebar.tsx`, `utils.tsx`, `AIView.tsx`, `use-toast.ts`, `App.tsx`, `Settings.tsx`, `SidebarPanel.tsx`, `carousel.tsx`, `ActiveChatPane.tsx`, `FlowsView.tsx`, `Inbox.tsx`, `Diagnostics.tsx`, `MessageRow.tsx`, `tabs.tsx`?**
