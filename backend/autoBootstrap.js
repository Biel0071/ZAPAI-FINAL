...
function runBootstrap() {
  ...
  const dbPassword = process.env.POSTGRES_PASSWORD || 'CHANGE_ME_IN_PRODUCTION';
  ...
  const adminPassword = process.env.AUTH_DEFAULT_PASSWORD || 'CHANGE_ME_IN_PRODUCTION';
...
`;
  ...
  try {
    ...
    console.log('[AUTO-BOOTSTRAP] Admin bootstrap placeholder active. Set AUTH_DEFAULT_PASSWORD to enable a real admin password.');
