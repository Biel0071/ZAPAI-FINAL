...
| `/inbox` | `Todo mundo fala de como ganhar mais.
Poucos falam ` | `chat-bubble text-left chat-bubble-received` | Not tested (safe/destructive mode or disabled) |
| `/inbox` | `Por isso eu passei os últimos meses
construindo um` | `chat-bubble text-left chat-bubble-received` | Not tested (safe/destructive mode or disabled) |
| `/inbox` | `O mercado digital cresceu.
...
📡 A` | `chat-bubble text-left chat-bubble-received` | Not tested (safe/destructive mode or disabled) |
...
| `/inbox` | `https://chat.whatsapp.com/GULnesHLRih9MdwZE6PVzS?s` | `chat-bubble text-left chat-bubble-received` | Not tested (safe/destructive mode or disabled) |
| `/inbox` | `Junte-se a mim no TikTok Lite!
...
| `/inbox` | `⚠️ *NOVIDADE, O MÉTODO ESTÁ DE VOLTA E TEMOS POUCA` | `chat-bubble text-left chat-bubble-received` | Not tested (safe/destructive mode or disabled) |
| `/inbox` | `*A Melhor Loja do Mercado Digital está ON!* 🔥🤯

` | `chat-bubble text-left chat-bubble-received` | Not tested (safe/destructive mode or disabled) |
| `/inbox` | `Rafael: Posso te passar o valor final e organizar ` | `chat-bubble text-left chat-bubble-sent` | Not tested (safe/destructive mode or disabled) |
...
*R$5K* - BM ` | `chat-bubble text-left chat-bubble-received` | Not tested (safe/destructive mode or disabled) |
| `/inbox` | `Pessoal, estou vendendo o domínio **raspanha.io** ` | `chat-bubble text-left chat-bubble-received` | Not tested (safe/destructive mode or disabled) |
| `/inbox` | `Bom dia, rapaziada!! ✨

👌No precinho: 

https://b` | `chat-bubble text-left chat-bubble-received` | Not tested (safe/destructive mode or disabled) |
| `/inbox` | `*A Melhor Loja do Mercado Digital está ON!* 🔥🤯

` | `chat-bubble text-left chat-bubble-received` | Not tested (safe/destructive mode or disabled) |
| `/inbox` | `*Assista onde quiser, quando quiser e sem complica` | `chat-bubble text-left chat-bubble-received` | Not tested (safe/destructive mode or disabled) |
| `/inbox` | `*CLARO TV + PREMIER + DISNEY PLUS + GLOBO PLAY!!* ` | `chat-bubble text-left chat-bubble-received` | Not tested (safe/destructive mode or disabled) |
| `/inbox` | `*A Melhor Loja do Mercado Digital está ON!* 🔥🤯
